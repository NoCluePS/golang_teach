...
func main() {
	...
	fmt.Printf("Average bandwidth usage: %v\nAverage cpu temp: %v°\nAverage memory usage: %v\n", dash.AverageBandwidth(), dash.AverageTemp(), dash.AverageMemory())
}

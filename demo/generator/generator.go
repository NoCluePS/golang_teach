...
func main() {
	...
	fmt.Println("generatRandInt infinite")
	...
	randIntnRange := generateRandIntn(2, 1, 100)

	fmt.Println("generatRandInt using finite count")

	for i := range randIntnRange {
		fmt.Println(i)
	}

	fmt.Println("generatRandInt using infinite loop")
